...
<section id="content">
	<div class="main">
		<div class="breadcrumb" style="margin: 0 0 0 15px">
			<a href="#">Home</a> / <a href="#">Alterar</a> / <strong>Perfil</strong>
		</div>
		<div class="container_24 relative">

			<article class="grid_14 a2">
				<div class="inner">
					<h3 class="hp-1">Alterar Perfil</h3>
					<div class="hr"></div>

					<form id="contact-form" action="altera"
						enctype="multipart/form-data" method="POST">
						<fieldset>
							<input type="hidden" id="confronto" value="${perfil.id}">
							<p>
								<label class="perfil">Perfil:<br /> <input type="text"
									name="perfil.perfil" value="${perfil.perfil}" />
								</label>
							</p>
							<p>
								<label class="descricao">Descricao:<br /> <input
									type="text" name="perfil.descricao" value="${perfil.descricao}" />
								</label>
							</p>
