...
<section id="content">
	<div class="main">
		<div class="breadcrumb" style="margin: 0 0 0 15px">
			<a href="#">Home</a> / <a href="#">Cadastrar</a> / <strong>Categoria
			</strong>
		</div>
		<div class="container_24 relative">
			...
			<article class="grid_14 a2">
				<div class="inner">
					<h3 class="hp-1">Cadastro de Categoria</h3>
					<div class="hr"></div>
						...
						<fieldset>
							<p>
								<label class="descricao"> Descricao:<br /> <input
									type="text" id="descricao" name="categoria.descricao">
								</label>
							</p>
							<p>
								<label class="peso_maximo"> Peso Maximo:<br /> <input
									type="text" id="peso_maximo" name="categoria.peso_maximo" />
								</label>
							</p>
							<p>
								<label class="peso_minimo"> Peso Minimo:<br /> <input
									type="text" id="peso_minimo" name="categoria.peso_minimo" />
								</label>
							</p>
							<div class="clear"></div>
							<br />
